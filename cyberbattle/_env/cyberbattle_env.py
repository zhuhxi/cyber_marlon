...
class CyberBattleEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.observation_space = spaces.Dict({
            ...
            'discovered_nodes_properties': spaces.Box(low=0, high=2, shape=(property_count * maximum_node_count, ), dtype=int),
    ...
    def __update_action_mask(self, bitmask: ActionMask) -> None:
        ...
        for source_node_id in self.__discovered_nodes:
            if self.__agent_owns_node(source_node_id):
                ...
                # Local: since the agent owns the node, all its local vulnerabilities are visible to it 这条假设暂时不考虑
