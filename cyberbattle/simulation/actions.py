...
class Penalty:
    ...
    BLOCKED_BY_LOCAL_FIREWALL = 0 # -10

    # traffic blocked by incoming rule in a remote firewall
    BLOCKED_BY_REMOTE_FIREWALL = 0 # -10
...
class AgentActions:
    ...
    def __init__(self, environment: model.Environment, throws_on_invalid_actions=True):
        ...
        # v2：内网横向移动攻击场景
        # for node_id, node_data in self._environment.nodes():
