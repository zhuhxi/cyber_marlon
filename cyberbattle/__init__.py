...
from ._env.defender import ScanAndReimageCompromisedMachines
...
if 'CyberBattleToyPch-v0' in registry.env_specs:
    del registry.env_specs['CyberBattleToyPch-v0']

register(
    id='CyberBattleToyPch-v0',
    cyberbattle_env_identifiers=toy_ctf.ENV_IDENTIFIERS,
    entry_point='cyberbattle._env.cyberbattle_toypch:CyberBattleToyPch',
...
if 'CyberBattleToyCtf-v1' in registry.env_specs:
    del registry.env_specs['CyberBattleToyCtf-v1']

register(
    id='CyberBattleToyCtf-v1',
    cyberbattle_env_identifiers=toy_ctf.ENV_IDENTIFIERS,
    entry_point='cyberbattle._env.cyberbattle_toyctf:CyberBattleToyCtf',
    kwargs={'defender_agent': ScanAndReimageCompromisedMachines(0.8, 1, 50),
            'attacker_goal': AttackerGoal(own_atleast=6),
            'defender_goal': DefenderGoal(eviction=True)
            },
    # max_episode_steps=2600,
